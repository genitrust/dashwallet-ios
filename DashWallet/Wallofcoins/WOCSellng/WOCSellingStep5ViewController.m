...
@interface WOCSellingStep5ViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation WOCSellingStep5ViewController
...
- (void)pushToStep6:(NSInteger)sender {
    ...
    WOCSellingStep6ViewController *myViewController = (WOCSellingStep6ViewController*)[self getViewController:@"WOCSellingStep6ViewController"];
