//
//  WOCSellingStep4ViewController.m
//  Wallofcoins
//
...
#import "WOCSellingStep5ViewController.h"
...
@interface WOCSellingStep4ViewController () <UITextFieldDelegate>

@end

@implementation WOCSellingStep4ViewController
...
- (void)sendUserData:(NSString*)amount zipCode:(NSString*)zipCode bankId:(NSString*)bankId {
    ...
    [[APIManager sharedInstance] discoverInfo:params response:^(id responseDict, NSError *error) {
        if (error == nil) {
            ...
            {
                WOCSellingStep5ViewController *myViewController = (WOCSellingStep5ViewController*)[self getViewController:@"WOCSellingStep5ViewController"];;
